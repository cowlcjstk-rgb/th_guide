...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <button
        className="fixed left-3 top-3 z-50 rounded-lg border border-slate-300 bg-white/95 px-3 py-2 text-xs font-semibold text-slate-900 shadow-sm backdrop-blur lg:hidden"
      ...
      <aside
        className={`fixed left-0 top-0 z-50 h-screen w-[280px] overflow-y-auto border-r border-slate-200 bg-white/95 backdrop-blur transition-transform lg:hidden ${
        ...
        <div className="min-w-0 pb-20 lg:pb-0">
          ...
          <footer className="mt-10 pb-8 text-xs text-slate-500">
            ...
            <div className="mt-2 flex flex-wrap gap-3">
              ...
              <a href="/api/health" className="hover:text-slate-800">
                시스템 상태
              </a>
            </div>
          </footer>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-4 px-2 py-1">
          <Link
            ...
            className={`rounded-lg px-2 py-2 text-center text-[11px] ${
              pathname === "/" ? "bg-slate-100 font-semibold text-slate-900" : "text-slate-600"
            }`}
          >
            홈
          </Link>
          <Link
            href="/places"
            className={`rounded-lg px-2 py-2 text-center text-[11px] ${
              pathname.startsWith("/places") ? "bg-slate-100 font-semibold text-slate-900" : "text-slate-600"
            }`}
          >
            장소
          </Link>
          <Link
            href="/map"
            className={`rounded-lg px-2 py-2 text-center text-[11px] ${
              pathname.startsWith("/map") ? "bg-slate-100 font-semibold text-slate-900" : "text-slate-600"
            }`}
          >
            지도
          </Link>
          <Link
            href="/community"
            className={`rounded-lg px-2 py-2 text-center text-[11px] ${
              pathname.startsWith("/community") ? "bg-slate-100 font-semibold text-slate-900" : "text-slate-600"
            }`}
          >
            커뮤니티
          </Link>
